       ...
       appBar: AppBar(
         actions: 
          [ Padding(
             ...
             child: Text("تعديل بيانات حسابي ",style:TextStyle(fontSize: 22,fontFamily: 'Lobster',height: 1.7)),
           ),], 
...
alignment: Alignment.center,
  child: Text("تم تعديل الحساب بنجاح",style: TextStyle(color: Color.fromRGBO(77, 0, 77, 1),fontSize: 20,fontWeight: FontWeight.bold),)) ,
content: Container(
height: 50,
child:Icon(Icons.add_task,color: Colors.green,size: 50,)
    ...
    child: Text(' حفظ التعديلات ',style: TextStyle(fontSize: 15)),
